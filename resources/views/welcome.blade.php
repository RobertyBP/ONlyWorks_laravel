        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/logout') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">logout</a>
                    @else
            ...
            <div>
                ...
                <div id="menu">
                            ...
                            <a href="{{ route('create') }}">Cadastrar Novo trabalho</a>
                            <a href="{{ route('exibir') }}">Exibir Lista de trabalhos</a>
                </div>
            </div>
        </div>
    </body>
